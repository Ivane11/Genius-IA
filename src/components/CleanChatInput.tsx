...
const CleanChatInput = ({ onSend, isLoading, mode }: CleanChatInputProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-gradient-to-t from-background via-background/95 to-transparent">
      <div className="max-w-3xl mx-auto">
        {/* Image Previews */}
        {images.length > 0 && (
          <div className="mb-3 p-3 rounded-xl bg-card/80 backdrop-blur-sm border border-border/30">
              ...
              {images.map((image) => (
                <div key={image.id} className="relative group">
                  <img 
                    src={image.url} 
                    alt={image.name}
                    className="h-16 w-full object-cover rounded-lg border border-border/20" 
                  />
                  <button
        ...
        {/* Main Input */}
        <div className="p-3 rounded-xl bg-card/80 backdrop-blur-sm border border-border/30 shadow-lg">
          <div className="flex items-end gap-2">
            ...
            <textarea
              ...
              rows={1}
              className="flex-1 bg-transparent resize-none outline-none text-sm text-foreground placeholder:text-muted-foreground py-2"
            />
